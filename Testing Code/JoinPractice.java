...
public class JoinPractice extends DriverSetup  {
	String baseUrl="https://courses.rahulshettyacademy.com/";
	
	@Test
public void JoinPractice() throws InterruptedException {
driver.get(baseUrl);
	...
	driver.findElement(By.name("email")).sendKeys("mahjabinmouly@gmail.com");
	Thread.sleep(2000);
