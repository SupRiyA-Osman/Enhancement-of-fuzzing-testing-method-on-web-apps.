...
public class wrong_email_pratice extends DriverSetup  {
	String baseUrl="https://courses.rahulshettyacademy.com/";
	
	@Test
public void wrong_email_pratice() throws InterruptedException {
driver.get(baseUrl);
	...
	Thread.sleep(2000);
	driver.findElement(By.name("name")).sendKeys("Mouly");
	Thread.sleep(2000);
	
	driver.findElement(By.name("email")).sendKeys("01716038569");
	Thread.sleep(2000);
